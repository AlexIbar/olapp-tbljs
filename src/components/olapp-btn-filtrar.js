...
export class OlappBtnFiltrar extends LitElement {
    static styles = [
        css`
            :host {
                display: flex;
...
customElements.define('olapp-btn-filtrar', OlappBtnFiltrar);
